...
# ---------- CONFIG ----------
API_KEY = "AIzaSyAqQKp8yeh_F0rGAKXe0mhrGiCnUUkkDs4"  # Gemini API Key
OPENROUTER_API_KEY = "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"  # OpenRouter API Key (replace with actual key)

# Database configuration
DB_HOST = "localhost"
DB_USER = "root"
DB_PASSWORD = "11022006Chin#"
DB_NAME = "ai_study_helper"

activity_log("Database configuration loaded")
